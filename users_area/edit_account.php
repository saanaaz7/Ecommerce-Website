<!-- get information from database and show in box -->
<?php
if(isset($_GET['edit_account'])){
    ...
    // when we click on update btn this will happen
    if(isset($_POST['user_update'])){
        ...
        if($result_query_update){
            echo "<script>alert('اطلاعات شما با موفقیت ویرایش شد')</script>";
...
<head>
    ...
    <title>ویراش اطلاعات</title>
</head>
<body>
    <h3 class="text-center text-success mb-4">ویراش اطلاعات</h3>
    <form action="" method"post" enctype="multipart/form-data" class="text-center">
        ...
        <input type="submit" value="ویراش" class="bg-info py-2 px-3 border-0" name="user_update">
    </form>
</body>
</html>