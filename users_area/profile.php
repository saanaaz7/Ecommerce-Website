...
<head>
    ...
    <title>سلام <?php echo $_SESSION['username'] ?></title>
    <!-- using php and mysql  -->
    <!-- bootstrap css link -->
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="profile.php">حساب کابری من</a>
        </li>
        <li class="nav-item">
...
<div class="row">
    <div class="col-md-2 bg-info p-0">
        ...
        <li class="nav-item bg-secondary">
          <a class="nav-link text-light"  href="#"><h4>پروفایل شما</h4></a>
        </li>
        <!-- dynamic image -->
        <?php
...
?>
        ...
        <li class="nav-item">
          <a class="nav-link text-light"  href="profile.php">سفارشات درحال پردازش</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light"  href="profile.php?edit_account">ویراش اطلاعات</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light"  href="profile.php?my_orders">سفارشات من</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-light"  href="profile.php?delete_account">حذف حساب کاربری</a>
        </li>
        <li class="nav-item">
